...
void array_copy(player_t copy[], player_t array[], unsigned int length) {
    ...
    /*Al cambiar la estructura a un puntero a una estructura,
    este seria un arreglo de "direcciones de memoria" por lo tanto 
    estaria mirando y modificando el arreglo original*/
